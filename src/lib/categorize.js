...
const RULES = [
  ...
  // Saúde
  ['sau', ['hospital', 'clinica', 'clínica', 'farmacia', 'farmácia', 'optica', 'ótica', 'optica universitaria', 'dentaria', 'dentária', 'analises', 'análises']],
  // Animais
  ['ani', ['barkibu', 'kiwoko', 'veterinar', 'petshop', 'pet shop', 'zooplus']],
  // Telecom
  ['tel', ['vodafone', 'meo', 'nos ', 'nowo', 'transatel', 'ubigi', 'digi ']],
  // Ginásio
  ['gym', ['vivagym', 'fitness hut', 'holmes place', 'ginasio', 'ginásio', 'gym']],
  // Combustível
  ['cmb', ['est servico', 'estacao servico', 'combu', 'repsol', 'galp', 'bp ', 'cepsa', 'prio', 'a.s.oeiras', 'pulsacao veloz', 'gasolina']],
  // Carro (manutenção, tracking, parques, portagens)
  ['car', ['cartrack', 'norauto', 'feu vert', 'midas', 'parque', 'parques tejo', 'via verde', 'brisa', 'portagem', 'estacionamento', 'ipark', 'empark']],
  // Negócio (ferramentas/serviços profissionais)
  ['neg', ['vercel', 'nabu casa', 'nabucasa', 'google workspace', 'hipay', 'eupago', 'aws', 'openai', 'anthropic', 'github', 'stripe', 'namecheap', 'cloudflare']],
  ...
  // Lazer
  ['laz', ['festival', 'krazy world', 'aventura', 'campo pequeno', 'plaj', 'supreme sports', 'minutos de leitura', 'narrativalegre', 'sporting clube', 'nyx arraial', 'cinema', 'nos cinemas', 'fnac', 'bilhet', 'teatro', 'museu', 'zoo', 'oceanario']],
  ...
  ['comp', ['ikea', 'decathlon', 'zippy', 'primark', 'jysk', 'leroy merlin', 'worten', 'fnac', 'mediamarkt', 'aki', 'maxmat', 'sport zone', 'nike', 'adidas', 'h&m', 'zara', 'bershka', 'pull', 'kidstore']],
  // Encargos bancários
