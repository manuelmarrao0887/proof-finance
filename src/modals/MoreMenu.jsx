...
const ITEMS = [
  ...
  { id: 'charts', title: 'Património', sub: 'Evolução, alocação e contas', svg: <><polyline points="3 17 9 11 13 15 21 7" /><polyline points="14 7 21 7 21 14" /></> },
  { id: 'report', title: 'Análise', sub: 'Fecho, saúde financeira e onde poupar', svg: <><path d="M9 17v-6M13 17v-2M17 17v-4" /><rect x="3" y="3" width="18" height="18" rx="2" /></> },
  ...
  { id: 'tax', title: 'Fiscal (IRS/IMI/IUC)', sub: 'Calendário e deduções estimadas', svg: <><path d="M9 11l3 3L22 4" /><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11" /></> },
  { id: 'cards', title: 'Cartões de crédito', sub: 'Plafond, dívida e pagamentos', svg: <><rect x="2" y="5" width="20" height="14" rx="2" /><line x1="2" y1="10" x2="22" y2="10" /></> },
