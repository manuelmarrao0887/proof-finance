/* ════════════════════════════════════════════════════════════════════════
   ...
   extra tabs (income, rec, cal, charts, loan, ai) + a Definicoes entry.

   Each tab item navigates via useUI().goTab(t) (which also closes this sheet);
   Definicoes closes the sheet then opens the settings modal. Uses the raw
...
const ITEMS = [
  { id: 'income', title: 'Receitas', sub: 'Salario e rendimentos', svg: <><line x1="12" y1="19" x2="12" y2="5" /><polyline points="5 12 12 5 19 12" /></> },
  { id: 'rec', title: 'Recorrentes', sub: 'Subscricoes e despesas fixas', svg: <><circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" /></> },
  { id: 'cal', title: 'Calendario', sub: 'Vista mensal de movimentos', svg: <><rect x="3" y="4" width="18" height="18" rx="2" /><line x1="16" y1="2" x2="16" y2="6" /><line x1="8" y1="2" x2="8" y2="6" /><line x1="3" y1="10" x2="21" y2="10" /></> },
  { id: 'charts', title: 'Graficos', sub: 'Evolucao patrimonial', svg: <><polyline points="3 17 9 11 13 15 21 7" /><polyline points="14 7 21 7 21 14" /></> },
  { id: 'loan', title: 'Credito', sub: 'Habitacao e dividas', svg: <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" /> },
